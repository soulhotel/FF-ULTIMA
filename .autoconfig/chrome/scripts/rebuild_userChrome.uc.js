...
UC.rebuild = {
  ...
  createButton (aDocument) {
    let toolbaritem = UC.rebuild.elBuilder(aDocument, 'toolbarbutton', {
      ...
      style: '--menuitem-icon: url(data:image/png;base64,)',
    });
    ...
    let mi1 = UC.rebuild.elBuilder(aDocument, 'menuitem', {
      ...
      flex: '1',
      style: '--menuitem-icon: url(data:image/png;base64,)',
