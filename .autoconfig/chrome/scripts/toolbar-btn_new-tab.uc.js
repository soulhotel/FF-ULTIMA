...
// middle-click on custom new tab button: closes the current tab
//
// Additional Close Tab Button
// left-click on custom close tab button: closes the current tab
