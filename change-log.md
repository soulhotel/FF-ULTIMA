...
### Change Log:
- `new` Setting `ultima.xstyle.private` for an alternative (de-cluttered) Private Browsing Mode Page.
- `todo` positioning adjustments
- `todo` animation transition adjustments
