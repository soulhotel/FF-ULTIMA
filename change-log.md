...
- `new` Try out `Tab groups` Firefox finally has tab groups & you now have FF Ultima options to style them `ultima.xstyle.tabgroups.i` by @tthornton3-chwy! and `ultima.xstyle.tabgroups.ii`
